@if ($paginator->hasPages())
    ...
    @else
        <li><a
                href="{{ $paginator->previousPageUrl() }}&category_id={{ request('category_id') }}&sort_by={{ request('sort_by') }}"><i
    ...
    @if ($paginator->hasMorePages())
        <li><a href="{{ $paginator->nextPageUrl() }}&category_id={{ request('category_id') }}&sort_by={{ request('sort_by') }}"><i
