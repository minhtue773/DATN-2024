                                            ...
                                            <div class="product-info">
                                                <div class="clearfix">
                                                    <h6 class="product-title f-left">
                                                        <a href="single-product.html">Tên sản phẩm giả</a>
                                                    </h6>
                                                ...
                                                <p>Có rất nhiều biến thể của các đoạn văn của Lorem Ipsum
                                                    có sẵn, nhưng phần lớn đã bị thay đổi theo một số
                                                    hình thức, bằng cách chèn hài hước hoặc những từ ngẫu nhiên
                                                    mà không nhìn thấy có vẻ như đáng tin cậy.</p>
                ...
                <div class="col-md-3 col-md-pull-9 col-sm-12">
                    ...
                    <aside class="widget widget-product box-shadow">
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                <h6 class="product-title">
                                    <a href="single-product.html">Mô hình xe hơi</a>
                                </h6>
                                <h3 class="pro-price">$ 869.00</h3>
                            </div>
                        </div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                <h6 class="product-title">
                                    <a href="single-product.html">Mô hình máy bay</a>
                                </h6>
                                <h3 class="pro-price">$ 869.00</h3>
                            </div>
                        </div>
                        ...
                        <div class="product-item">
                            ...
                            <div class="product-info">
                                <h6 class="product-title">
                                    <a href="single-product.html">Mô hình tàu thủy</a>
                                </h6>
                                <h3 class="pro-price">$ 869.00</h3>
                            </div>
                        </div>
