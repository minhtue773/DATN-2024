                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- <div class="col-sm-6">
                                                        <select class="custom-select">
                                                            <option value="defalt">Quốc Gia</option>
                                                            <option value="c-1">Việt Nam</option>
                                                            <option value="c-2">Úc</option>
                                                            <option value="c-3">Bangladesh</option>
                                                            <option value="c-4">Hoa Kỳ</option>
                                                            <option value="c-5">Vương Quốc Anh</option>
                                                        </select>
                                                    </div> -->
                                                    <!-- <div class="col-sm-6">
                                                        <select class="custom-select">
                                                            <option value="defalt">Tỉnh/Thành Phố</option>
                                                            <option value="c-1">Hà Nội</option>
                                                            <option value="c-2">Hồ Chí Minh</option>
                                                            <option value="c-3">Đà Nẵng</option>
                                                            <option value="c-4">Nha Trang</option>
                                                        </select>
                                                    </div> -->
