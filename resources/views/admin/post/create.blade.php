                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="Nhập tiêu đề..." name="title" id="title" value="{{ old('title') }}" onkeyup="ChangeToSlug()"> 
                                        @error('title')
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="abc-abv-ab..." name="slug" id="slug" value="{{ old('slug') }}"> 
                                        @error('slug')
                                            <p class="text-danger m-0 mt-1">* {{ $message }}</p>
                                        @enderror
                                    </div>                                                                                                                                                
