    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            <div class="col-lg-6 pb-5">
                <div style="max-width: 700px; margin:auto;" id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        ...
                        <div class="carousel-item active">
                            ...
                            @endif
                            <img class="w-100 h-100" src="{{ asset('uploads/product/' . $sp->image) }}" alt="Image">
                        </div>

                        <!-- Hình ảnh liên quan -->
                        @foreach ($sp->productImages as $hinh)
                        <div class="carousel-item">
                            ...
                            @endif
                            <img class="w-100 h-100" src="{{ asset('uploads/product/' . $hinh->image) }}" alt="Image">
                        </div>
                        @endforeach
            ...
            <div class="col-lg-6 pb-5">
                ...
                <p class="text-dark font-weight-medium mb-0 mr-3" style="margin-top: 2%">
                    Danh Mục: {{ $sp->productCategory->name ?? 'N/A' }}
                </p>
                @if ($sp->stock == 0)
                ...
                @if ($sp->discount > 0)
                <h3>{{ number_format($sp->price, 2) }} $</h3>

                <h3 class="text-muted ml-2"><del>{{ number_format($sp->price + ($sp->price * $sp->discount / 100), 2) }} $</del></h3>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    @foreach ($sp->relatedProducts() as $product)
