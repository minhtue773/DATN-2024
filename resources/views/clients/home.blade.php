...
<div id="header-carousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item {{ $index == 0 ? 'active' : '' }}" style="height: 410px;">
            <img class="img-fluid" src="{{ asset( 'uploads/banner/'. $banner->image) }}" alt="{{ $banner->name }}">
    ...
    <div class="row px-xl-5 pb-3">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                ...
                <h5 class="font-weight-semi-bold m-0">Miễn phí giao hàng TP. HCM</h5>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
        ...
        <div class="col-lg-2 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                ...
                <a href="" class="cat-img position-relative overflow-hidden mb-3">
                    <img class="img-fluid" src="{{ asset('uploads/product/' . $category->image) }}" alt="{{ $category->name }}">
                </a>
        ...
        <div class="col">
            <div class="owl-carousel vendor-carousel">
                ...
                <div class="vendor-item border p-4 text-center">
                    <img src="{{ asset('uploads/product/'. $category->image) }}" alt="{{ $category->name }}">
