                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="{{asset('uploads/images/transformer2.png')}}"
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="{{route('register')}}" method="POST">
                                        ...
                                        <h5 class="fw-normal mb-3" style="letter-spacing: 1px;">Tạo tài khoản</h5>
                                        <div data-mdb-input-init class="input-group form-outline mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                            </div>
                                            <input type="text" id="form2Example17" name="name" class="form-control form-control-lg" placeholder="Tên tài khoản" />
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="pt-1 mb-3">
                                            <button data-mdb-button-init data-mdb-ripple-init class="btn btn-dark btn-lg btn-block" type="submit">Đăng ký</button>
                                        </div>

                                        <p class="mb-3 pb-lg-2" style="color: #393f81;">Đã có tài khoản? <a href="{{route('login')}}"
                                                style="color: #393f81;">Đăng nhập ngay</a></p>

                                        <a href="{{ url('auth/google') }}" class="btn btn-lg btn-block btn-primary" style="background-color: #dd4b39;color:#ffff;text-decoration:none;"><i class="fab fa-google me-2"></i> Đăng ký bằng google</a>

                                        <a href="{{ url('auth/facebook') }}" class="btn btn-lg btn-block btn-primary " style="color:#ffff;text-decoration:none;background-color: #3b5998;"><i class="fab fa-facebook-f me-2"></i> Đăng ký bằng facebook</a>
